...
DB_CONN = 0
#daaaates = pd.date_range('20050101', '20191101')
daaaates = pd.date_range('20141101', '20191101')

##test data replace with each factor.h5
fcl = ['date','cash','operate_profit','operate_expense']
st = pd.HDFStore('A.h5')
